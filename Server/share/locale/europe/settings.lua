...
add_goto_info("deviltower", 0, 66, 2048, 6656)
...
add_goto_info("gm_building", 0, 1, 832, 0)
...
add_goto_info("element1", 0, 378, 0, 9216)
add_goto_info("element2", 0, 379, 1280, 9216)
add_goto_info("element3", 0, 380, 2560, 9216)
add_goto_info("element4", 0, 381, 3840, 9216)

add_goto_info("ep1", 0, 373, 10496, 4352)
add_goto_info("ep2", 0, 376, 11520, 4352)
add_goto_info("ep3", 0, 377, 12288, 4352)

add_goto_info("maze_dungeon1", 0, 382, 7680, 12032)
add_goto_info("maze_dungeon2", 0, 383, 8448, 12032)
add_goto_info("maze_dungeon3", 0, 384, 9216, 12032)

add_goto_info("privateshop", 0, 392, 0, 3584)
add_goto_info("empirecastle", 0, 374, 5120, 4864)
add_goto_info("eastplain1", 0, 373, 11024, 5068)
add_goto_info("eastplain2", 0, 376, 12233, 4917)
add_goto_info("eastplain3", 0, 377, 12796, 4409)
add_goto_info("211", 0, 211, 7923, 9479)

add_bgm_info(211, "Only_my_battle.mp3", 0.5);		-- metin2_map_kingdoomswar
...
dofile(get_locale_base_path() .. "/GuildDragonLair.lua")
